...
function keepLanguage2() {
  ...
  let translations = {
    "english": {
      "aboutTitle": "About",
      "aboutText1": "R&D AI Engineer with 4+ years of expertise in AI/LLM/RAG development, ML/DL models, and 3D data processing. Currently leading AI strategy and innovation at Understand Tech, where I build and scale the AI department while developing a best-in-class enterprise AI platform focused on efficiency, reliability, and security. Specializing in NLP and Computer Vision, I create impactful open-source AI solutions that enhance product quality and operational efficiency across industries including energy and dentistry. Proficient in the full AI development lifecycle—from data preprocessing to deployment—I align technical innovation with business objectives. Bilingual (French/English) professional committed to leveraging AI for innovative problem-solving and continually exploring emerging technologies through personal projects. ",
      "aboutText2": "My goal is to harness the power of AI and software development to drive innovation and make a positive impact on businesses and society.",
      "aboutWhatIDo":"What I Do!",
      "aboutDSTitle":"Data Science",
      "aboutDSDescription":"I specialize in Data Science, crafting and fine-tuning AI/ML/DL models specialy for Natural Language Processing, Large Language Models (LLMs) and Computer Vision.",
      ...
      "resumeSkills1": "Programming Languages",
      "resumeSkills2": "Data Processing",
      "resumeSkills3": "Natural Language Processing",
      "resumeSkills4": "Databases",
      "resumeSkills5": "Data Visualization",
      "resumeSkills6": "Web/API Development",
      ...
      "portfolioQRCode1" : "Web application, UX/UI",
      "portfolioQRCode2" : "QR Code Generator",

      "worksQRCode": "<p>An intuitive, free and user-friendly QR Code Generator developed using HTML, CSS, and JavaScript, designed to deliver a seamless user experience. Enables the creation of QR codes from a variety of input types including Text, URLs, and Wi-Fi Network details with ease. Users are empowered with the ability to customize the QR code’s appearance by altering its color scheme and can download the generated code in a PNG format. Particularly focused on providing a straightforward, navigable UI to accommodate both tech-savvy users and digital beginners alike. </p> <p> The project was developed using the following tools: <ol> <li>HTML</li> <li>CSS</li> <li>JavaScript</li> <li>Adobe Firefly</li> </ol> </p>" ,
      ...
      "worksPersonalProject":  "Personal Project",
      "clickHere" : "Click here",

      "contactText1" :"Let's connect and explore the possibilities in AI together! Whether you have exciting opportunities, thought-provoking questions, innovative collaboration ideas, or just want to geek out about the latest in AI, I'm all ears.",
      "contactText2" :"Ready to chat? Drop me a message and let's start a conversation!",
      "contactName" :"name *",
      "contactEmail" :"email *",
    ...
    "french": {
      "aboutTitle": "À propos",
      "aboutText1": "Ingénieur R&D en IA avec plus de 4 ans d'expertise en développement AI/LLM/RAG, modèles ML/DL, et traitement de données 3D. Actuellement responsable de la stratégie IA et de l'innovation chez Understand Tech, où je pilote la création et le développement du département IA tout en construisant une plateforme d'IA d'entreprise de premier plan axée sur l'efficacité, la fiabilité et la sécurité. Spécialisé dans le NLP et la vision par ordinateur, je développe des solutions d'IA open-source à fort impact qui améliorent la qualité des produits et l'efficacité opérationnelle dans des secteurs tels que l'énergie et la dentisterie. Je maîtrise l'ensemble du cycle de développement de l'IA—du prétraitement des données au déploiement—en alignant l'innovation technique avec les objectifs business. Bilingue (français/anglais), je m'engage à tirer parti de l'IA pour résoudre des problèmes de manière innovante et à explorer en permanence les technologies émergentes dans le cadre de projets personnels. ",
      "aboutText2": "Mon objectif est d'exploiter la puissance de l'IA et du développement de logiciels pour stimuler l'innovation et avoir un impact positif sur les entreprises et la société.",
      ...
      "resumeExperience1.1": "R&D Artificial Intelligence Engineer",
      "resumeExperience1.2": "07.2025 - Présent",
      "resumeExperience1.3": "Aix-en-Provence - France.",
      "resumeExperience2.1": "R&D Artificial Intelligence Engineer",
      ...
      "resumeSkills1": "Langages de programmation",
      "resumeSkills2": "Traitement des données",
      "resumeSkills3": "Traitement Automatique du Langage",
      "resumeSkills4": "Bases de données",
      "resumeSkills5": "Visualisation des données",
      "resumeSkills6": "Développement Web",
      ...
      "worksQRCode": "<p>Un générateur de codes QR intuitif, gratuit et convivial, développé en utilisant HTML, CSS et JavaScript, conçu pour offrir une expérience utilisateur fluide. Il permet la création de codes QR à partir de divers types d'entrées, notamment du texte, des URL et des détails de réseaux Wi-Fi, en toute simplicité. Les utilisateurs ont la possibilité de personnaliser l'apparence du code QR en modifiant son schéma de couleurs et peuvent télécharger le code généré au format PNG. Particulièrement axé sur la fourniture d'une interface utilisateur simple et navigable pour accueillir aussi bien les utilisateurs avertis en technologie que les débutants du numérique. </p> <p> Le projet a été développé en utilisant les outils suivants : <ol> <li>HTML</li> <li>CSS</li> <li>JavaScript</li> <li>Adobe Firefly</li> </ol> </p>",
      ...
      "worksRAG":"<p>Ce système de génération augmentée par récupération (RAG) a remporté la 1ère place du Secure RAG Challenge organisé par UnderstandTech, démontrant l'excellence dans la construction de solutions d'IA sécurisées et hors ligne avec un accent sur la confidentialité des données et les technologies open source. J'ai conçu un pipeline sophistiqué en plusieurs étapes qui combine un traitement avancé de documents, des mécanismes de récupération hybrides et une intégration optimisée de modèles de langage. Le système exploite Docling pour une conversion PDF-vers-Markdown de qualité supérieure, implémente une stratégie de double encodage utilisant Nomic Embed pour la compréhension sémantique et BM25 avec TF-IDF pour la correspondance de mots-clés, et utilise une base de données vectorielle FAISS ainsi qu'un BGE Reranker pour garantir des résultats très pertinents. Grâce à l'intégration de Llamafile, j'ai obtenu une optimisation flexible des performances CPU/GPU, permettant une inférence efficace tout en maintenant le contrôle des ressources—le tout testé et optimisé sur des configurations matérielles avec 32 Go de RAM et 8 Go de VRAM. </p> <p> J'ai conçu le système pour gérer de manière transparente divers types de contenu, prenant en charge les documents texte (Markdown, PDF, CSV, HTML), plusieurs langages de programmation (Python, JavaScript, Java, C++, Go, Rust, et plus encore), et la documentation technique avec une analyse intelligente qui préserve les hiérarchies d'en-têtes et les métadonnées. Les principales réalisations techniques incluent la mise en œuvre d'un système de cache avancé pour des performances optimisées, des embeddings accélérés par GPU avec gestion automatique de la mémoire, des opérations LLM thread-safe, et un pipeline de traitement configurable avec journalisation complète et suivi de la progression. La solution dispose d'une interface web Streamlit conviviale et met l'accent sur les considérations de déploiement pratiques, la rendant adaptée aux environnements de production nécessitant des capacités RAG sécurisées et hors ligne avec une surcharge computationnelle minimale.</p>",
      ...
      "worksPersonalProject":  "Projet Personnel",
      "clickHere" : "Cliquez ici",

      "contactText1" :"Prenons contact et explorons ensemble les possibilités qu'offre l'IA ! Que vous ayez des opportunités passionnantes, des questions qui font réfléchir, des idées de collaboration innovantes ou que vous souhaitiez simplement vous informer sur les dernières nouveautés en matière d'IA, je suis à votre écoute.",
      "contactText2" :"Prêt à discuter ? Envoyez-moi un message et entamons une conversation !",
      "contactName" :"nom *",
      "contactEmail" :"email *",
      "contactMessage" :"message *",
